      ...
      <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
            ...
            and the{' '}
            <a href="https://flowbite.com/blocks/" target="_blank" rel="noopener noreferrer" className="hover:underline">
              Blocks System
            </a>.
          </p>
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
          <img src="https://via.placeholder.com/150/0000FF/808080 ?Text=PAKAINFO.com" alt="mockup" className="w-full h-auto" />
        </div>
      </div>
    </section>
  );
